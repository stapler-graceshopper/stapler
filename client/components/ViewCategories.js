    ...
    return (
      <div>
        ...
        <form className="inputText" onSubmit={this.handleAddCategory}>
          <label htmlFor="Add a Category to the Database" className="center">
        ...
        <form
          className="inputText"
          onSubmit={event => this.handleDeleteCategory(event, catsByName)}
        >
          <label htmlFor="Delete a Category to the Database" className="center">
